...
ЕСЛИ ЭТО НЕ ПОМОГЛО, ТО ПОМЕНЯЙТЕ В ФАЙЛЕ "symbols.py" ЗНАЧЕНИЯ СООТВЕТСТВЕННЫХ СИМВОЛОВ НА ДРУГИЕ.
  Например: символ стакана можно заменить на "П", а символ звёздочи на "*" (то же самое происходит при
